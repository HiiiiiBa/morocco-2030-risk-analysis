...
export default function CityTransportContent({ citySlug }: CityTransportContentProps) {
  ...
  useEffect(() => {
    // Trouver la ville
    const foundCity = moroccanCities.find((c) => c.slug === citySlug)
  ...
  return (
    <div className="space-y-6">
      {/* En-tête */}
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Transport en {city.name}</h2>
